...
::: {.g-col-6}
### 🧠 MNE Topoplots
Interactive EEG/MEG topographic maps with smooth interpolation and automatic channel positioning from MNE-Python data.

[See Examples →](examples/mne_topoplot.qmd)
:::
